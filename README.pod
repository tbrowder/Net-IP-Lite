...
Returns           : expanded IP address or '' on failure
...
Returns           : reversed IP address or '' on failure
...
These functions are used internally by the default exported
...
providing such a useful set of functions: Manuel Valente
<manuel.valente@gmail.com>, Monica Cortes Sack <mcortes@ripe.net>, and
